  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="flex flex-col gap-4 bg-gray-100  p-8 w-full max-w-md authCustom">
        ...
        <p className="text-sm textCustom">Don&apos;t you have an account? <a className="text-black font-bold" href="/register">Signup</a></p>
        <form>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <input className="inputCustom w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300 focus:shadow-md" type="password" placeholder="Password" />
          </div>
